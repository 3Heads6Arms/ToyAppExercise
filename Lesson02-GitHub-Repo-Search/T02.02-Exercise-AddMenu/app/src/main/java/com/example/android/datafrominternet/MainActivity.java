...
public class MainActivity extends AppCompatActivity {
    ...
    // COMPELTED (8) Override onCreateOptionsMenu
    // COMPELTED (9) Within onCreateOptionsMenu, use getMenuInflater().inflate to inflate the menu
    // COMPELTED (10) Return true to display your menu
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if(item.getItemId() == R.id.action_search){
            Toast.makeText(this, "Menu item \"Search\" touched", Toast.LENGTH_SHORT).show();
        }
