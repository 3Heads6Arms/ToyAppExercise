...
public class AddTaskActivity extends AppCompatActivity {
    ...
    private EditText mTaskDescriptionEt;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTaskDescriptionEt = (EditText) findViewById(R.id.editTextTaskDescription);
        mPriority = 1;
    }
    ...
    public void onClickAddTask(View view) {
        ...
        String description = mTaskDescriptionEt.getText().toString();
        if (!TextUtils.isEmpty(description)) {
            ...
            Uri result = getContentResolver()
                    .insert(TaskContract.TaskEntry.CONTENT_URI, contentValues);
