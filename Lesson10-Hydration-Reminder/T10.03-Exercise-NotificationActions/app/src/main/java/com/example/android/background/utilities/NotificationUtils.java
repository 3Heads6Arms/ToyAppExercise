...
public class NotificationUtils {
    ...
    private static final int ACTION_IGNORE_PENDING_INTENT_ID = 1326;
    private static final int ACTION_INCREMENT_WATER_DRINK_ID = 1237;
    ...
    public static NotificationCompat.Action ignoreReminderAction(Context context) {
        ...
        waterReminderIntent.setAction(ReminderTasks.ACTION_DISMISS_NOTIFICATION);
        ...
        NotificationCompat.Action action = new NotificationCompat.Action(R.drawable.ic_drink_notification, "No, thanks", pendingIntent);
    ...
    public static NotificationCompat.Action drinkWaterAction(Context context) {
        ...
        PendingIntent pendingIntent = PendingIntent.getService(
                context,
                ACTION_INCREMENT_WATER_DRINK_ID,
                intent,
                PendingIntent.FLAG_UPDATE_CURRENT);
        //      COMPLETED (15) Create an Action for the user to tell us they've had a glass of water
        NotificationCompat.Action action = new NotificationCompat.Action(R.drawable.ic_drink_notification, "Drink", pendingIntent);
