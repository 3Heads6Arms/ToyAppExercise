...
public class MainActivity extends AppCompatActivity implements
    ...
    protected void onResume() {
        ...
        // COMPLETED (4) If your user is not on M+, then...
            ...
            int extraStatus = intent.getIntExtra(BatteryManager.EXTRA_STATUS, 0);
            boolean isCharging = extraStatus == BatteryManager.BATTERY_STATUS_FULL ||
                    extraStatus == BatteryManager.BATTERY_STATUS_CHARGING;
